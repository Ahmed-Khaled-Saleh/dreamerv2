...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/03_models_dense.ipynb.

# %% auto 0
__all__ = ['DenseModel']

# %% ../../nbs/03_models_dense.ipynb 3
import numpy as np
import torch
