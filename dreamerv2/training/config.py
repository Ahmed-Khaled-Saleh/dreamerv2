...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/02_training.config.ipynb.

# %% auto 0
__all__ = ['MinAtarConfig', 'MiniGridConfig']

# %% ../../nbs/02_training.config.ipynb 2
import numpy as np
...
# %% ../../nbs/02_training.config.ipynb 3
@dataclass
class MinAtarConfig():
...
# %% ../../nbs/02_training.config.ipynb 4
@dataclass
