...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/03_training.trainer.ipynb.

# %% auto 0
__all__ = ['Trainer']

# %% ../../nbs/03_training.trainer.ipynb 2
import numpy as np
import torch 
...
from ..utils.algorithm import compute_return
...
# %% ../../nbs/03_training.trainer.ipynb 3
...
# %% ../../nbs/03_training.trainer.ipynb 4
@patch
def collect_seed_episodes(self: Trainer, env):
...
# %% ../../nbs/03_training.trainer.ipynb 5
@patch
def train_batch(self: Trainer, train_metrics):
    """ 
...
# %% ../../nbs/03_training.trainer.ipynb 6
@patch
def actorcritc_loss(self: Trainer, posterior):
    with torch.no_grad():
...
# %% ../../nbs/03_training.trainer.ipynb 7
@patch
def representation_loss(self: Trainer, obs, actions, rewards, nonterms):
...
# %% ../../nbs/03_training.trainer.ipynb 8
@patch
def _actor_loss(self: Trainer, imag_reward, imag_value, discount_arr, imag_log_prob, policy_entropy):
...
# %% ../../nbs/03_training.trainer.ipynb 9
@patch
def _value_loss(self: Trainer, imag_modelstates, discount, lambda_returns):
    with torch.no_grad():
...
@patch
def _obs_loss(self: Trainer, obs_dist, obs):
    obs_loss = -torch.mean(obs_dist.log_prob(obs))
    return obs_loss
    

# %% ../../nbs/03_training.trainer.ipynb 10
@patch
def _kl_loss(self: Trainer, prior, posterior):
...
# %% ../../nbs/03_training.trainer.ipynb 11
@patch
def _reward_loss(self: Trainer, reward_dist, rewards):
    reward_loss = -torch.mean(reward_dist.log_prob(rewards))
    return reward_loss

@patch
def _pcont_loss(self: Trainer, pcont_dist, nonterms):
    pcont_target = nonterms.float()
    pcont_loss = -torch.mean(pcont_dist.log_prob(pcont_target))
    return pcont_loss
@patch
def update_target(self: Trainer):
...
# %% ../../nbs/03_training.trainer.ipynb 12
@patch
def save_model(self: Trainer, iter):
...
@patch
def get_save_dict(self: Trainer):
    return {
...
@patch
def load_save_dict(self: Trainer, saved_dict):
...
# %% ../../nbs/03_training.trainer.ipynb 13
@patch
def _model_initialize(self: Trainer, config):
...
# %% ../../nbs/03_training.trainer.ipynb 14
@patch

def _optim_initialize(self: Trainer, config):
...
# %% ../../nbs/03_training.trainer.ipynb 15
@patch
